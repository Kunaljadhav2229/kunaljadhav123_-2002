...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO ashtavinayaktemplecomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: ashtavinayak temple.php");
  } else {
...
<head>
  ...
  <title>ASHTAVINAYAK TEMPLE</title>
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Ashtavinayak Temple.jpg" width="670" height="300"/>
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>Ashtavinayak Temple of Latur is considered as one of the most prominent Ganesha Temples in the region. It is located with Latur city limits.Situated in the heart of Latur town, Ashtavinayak Temple is considered one of the auspicious Eight Swayambhu Temples in the state of Maharashtra. The temple was constructed back in 1989 and is known for its marvelous South Indian temple design and the intricate carvings on it. The temple is bordered by scenic gardens on both the sides as well as fountains in the vicinity. The entrance nestles a colossal statue of Lord Shiva and then the main hall of temple has around 8 statues of Lord Ganapati.The Ashtavinayak Temples are a group of eight holy temples situated in the state of Maharashtra. Each of these temples is associated with legends of Lord Ganesha and is considered as a part of pilgrimage dedicated to the Lord. The Ashtavinayak Temples should be visited in a pre-determined sequence. It should begin with Sri Moreshwar Temple followed by the Siddhivinayak Temple, Ballaleshwar Temple, Varadvinayak Temple, Chintamani Temple, Girijatmaj Temple and the Vignahar Temple. The last temple in the list is the Mahaganapathi Temple at Ranjangaon, Pune. It is believed that the pilgrimage is complete only when the devotee visits the first temple again after visiting all the other seven temples.</h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM ashtavinayaktemplecomment";
        $result = mysqli_query($conn, $sql);
        if (

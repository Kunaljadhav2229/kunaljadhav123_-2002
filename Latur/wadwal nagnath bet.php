...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO wadwalnagnathbetcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: wadwal nagnath bet.php");
  } else {
...
<head>
  ...
  <title>WADWAL NAGNATH BET</title>
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Wadwal Nagnath Bet.jpg" width="670" height="300"/>
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>The Sanjivani Bet, also called as Wadwal Nagnath Bet, is a hill and a bioshpere reserve located near the Wadwal Naganath village, in the Latur District of Maharastra. It is located at a distance of 16 km from Chakur and 39 kms from Latur city.The Sanjivani Bet (Wadwal Nagnath Bet) is known being home to many rare species of Ayurvedic bushes and plants. The rare plants grow in the month July to September (Uttara Nakshatra). In this period Ayurvedic practitioners, and researchers from various places visit this place in search of rare plants. The Government of Maharashtra organises Vaidya Sammelan (conference) for various Ayurvedic doctors and, local practitioners who use traditional remedies for primary healthcare.The government has also established a research centre for the study of medicinal plants. Visitors can also interact with the local tribes, who are very informative when it comes to Sanjivani Bet.There are many aurvedic and natural therapy hospitals and medical shops in and around the the Wadwal Nagnath Betta where one can shop into those places. </h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM wadwalnagnathbetcomment";
        $result = mysqli_query($conn, $sql);
        if (

...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO diveagar_beachcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: diveagar_beach.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\diveagar_beach.webp" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM diveagar_beachcomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      ...
      <div class="card">
      <h3><a href="takmak_tok.php">TAKMAK_TOK</a></h3>
        <img src="images\takmak_tok.jpg" alt="Maha" />
      </div>
      <div class="card">

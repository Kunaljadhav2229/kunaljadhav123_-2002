...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO takmak_tokcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: takmak_tok.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\takmak_tok.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      Perched at an elevation of 1200 feet, Takmak Trek takes you to one of the most marvelous views witnessed from tourist places in Raigad. It is famed in history as a place where criminals were executed in the past.
      ...
      Location: Raigarh Fort, Raigad Trail, Gherakilla Raigad, Maharashtra.
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM takmak_tokcomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      ...
      <div class="card">
        <h3><a href="raigad_museum.php">RAIGAD MUSEUM</a></h3>
        <img src="images\raigad_museum.jpg" alt="Pratap" />
      </div>
